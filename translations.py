...
# --- NEW: Dictionary for translating language names ---
# This allows the dropdowns to show language names in the UI's current language.
LANG_NAMES = {
    "Arabic": {"ru": "Арабский", "hu": "Arab"},
    "Chinese (Mandarin)": {"ru": "Китайский (Мандарин)", "hu": "Kínai (Mandarin)"},
    "Dutch": {"ru": "Голландский", "hu": "Holland"},
    "English": {"ru": "Английский", "hu": "Angol"},
    "Finnish": {"ru": "Финский", "hu": "Finn"},
    "French": {"ru": "Французский", "hu": "Francia"},
    "German": {"ru": "Немецкий", "hu": "Német"},
    "Hungarian": {"ru": "Венгерский", "hu": "Magyar"},
    "Italian": {"ru": "Итальянский", "hu": "Olasz"},
    "Japanese": {"ru": "Японский", "hu": "Japán"},
    "Norwegian": {"ru": "Норвежский", "hu": "Norvég"},
    "Polish": {"ru": "Польский", "hu": "Lengyel"},
    "Portuguese": {"ru": "Португальский", "hu": "Portugál"},
    "Russian": {"ru": "Русский", "hu": "Orosz"},
    "Spanish": {"ru": "Испанский", "hu": "Spanyol"},
    "Swedish": {"ru": "Шведский", "hu": "Svéd"},
    "Turkish": {"ru": "Турецкий", "hu": "Török"},
}

# The dictionary holding all UI string translations.
TRANSLATIONS = {
...
def get_translated_lang_name(english_name):
    """Translates a language name into the current UI language."""
